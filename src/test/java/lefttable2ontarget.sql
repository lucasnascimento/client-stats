...
CREATE TABLE `Tabela2` (
  `tabela2_pk` int(11) NOT NULL,	
  `tabela2_campo1` varchar(45) DEFAULT NULL,
  `tabela2_campo2` decimal(14,2) DEFAULT NULL,
  PRIMARY KEY (`tabela2_pk`),
  KEY `IDX_Tabela2` (`tabela2_campo1`,`tabela2_campo2`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
